...
/**
 * Provides the local service interface for tab_ResearchObject. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Felicitas Loeffler
 * @see tab_ResearchObjectLocalServiceUtil
...
public interface tab_ResearchObjectLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link tab_ResearchObjectLocalServiceUtil} to access the tab_ research object local service. Add custom service methods to {@link org.gfbio.service.impl.tab_ResearchObjectLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
