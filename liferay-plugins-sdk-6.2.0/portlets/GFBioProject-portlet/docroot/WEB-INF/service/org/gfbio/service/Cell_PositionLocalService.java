...
/**
 * Provides the local service interface for Cell_Position. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Marcel Froemming
 * @see Cell_PositionLocalServiceUtil
...
public interface Cell_PositionLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link Cell_PositionLocalServiceUtil} to access the cell_ position local service. Add custom service methods to {@link org.gfbio.service.impl.Cell_PositionLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
