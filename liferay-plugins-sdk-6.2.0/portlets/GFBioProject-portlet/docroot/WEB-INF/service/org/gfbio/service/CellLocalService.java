...
/**
 * Provides the local service interface for Cell. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Marcel Froemming
 * @see CellLocalServiceUtil
...
public interface CellLocalService extends BaseLocalService, InvokableLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CellLocalServiceUtil} to access the cell local service. Add custom service methods to {@link org.gfbio.service.impl.CellLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
