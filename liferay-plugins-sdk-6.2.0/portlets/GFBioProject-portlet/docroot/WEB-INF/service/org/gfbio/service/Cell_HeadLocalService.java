...
/**
 * Provides the local service interface for Cell_Head. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Marcel Froemming
 * @see Cell_HeadLocalServiceUtil
...
public interface Cell_HeadLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link Cell_HeadLocalServiceUtil} to access the cell_ head local service. Add custom service methods to {@link org.gfbio.service.impl.Cell_HeadLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
