...
/**
 * Provides the local service interface for Project_User_Worker. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author froemm
 * @see Project_User_WorkerLocalServiceUtil
...
public interface Project_User_WorkerLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link Project_User_WorkerLocalServiceUtil} to access the project_ user_ worker local service. Add custom service methods to {@link org.gfbio.service.impl.Project_User_WorkerLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
