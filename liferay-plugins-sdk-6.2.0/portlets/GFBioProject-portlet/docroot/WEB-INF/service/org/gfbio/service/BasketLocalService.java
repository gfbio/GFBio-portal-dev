...
/**
 * Provides the local service interface for Basket. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Felicitas Loeffler
 * @see BasketLocalServiceUtil
...
public interface BasketLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link BasketLocalServiceUtil} to access the basket local service. Add custom service methods to {@link org.gfbio.service.impl.BasketLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
