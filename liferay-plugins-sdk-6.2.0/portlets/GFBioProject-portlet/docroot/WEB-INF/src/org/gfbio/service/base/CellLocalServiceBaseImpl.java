...
import org.gfbio.service.CellLocalService;
...
/**
 * Provides the base implementation for the cell local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.gfbio.service.impl.CellLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class CellLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements CellLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.gfbio.service.CellLocalServiceUtil} to access the cell local service.
	 */
	...
	@Override
	public Cell addCell(Cell cell) throws SystemException {
		cell.setNew(true);

		return cellPersistence.update(cell);
	}
	 ...
	 */
	@Override
	public Cell createCell(long cellID) {
		return cellPersistence.create(cellID);
	}
	...
	@Override
	public Cell deleteCell(long cellID) throws PortalException, SystemException {
		return cellPersistence.remove(cellID);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Cell deleteCell(Cell cell) throws SystemException {
		return cellPersistence.remove(cell);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Cell.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return cellPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return cellPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return cellPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery,
		...
		return cellPersistence.countWithDynamicQuery(dynamicQuery, projection);
	}

	@Override
	public Cell fetchCell(long cellID) throws SystemException {
		return cellPersistence.fetchByPrimaryKey(cellID);
	}
	 ...
	 */
	@Override
	public Cell getCell(long cellID) throws PortalException, SystemException {
		return cellPersistence.findByPrimaryKey(cellID);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return cellPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<Cell> getCells(int start, int end) throws SystemException {
		return cellPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getCellsCount() throws SystemException {
		return cellPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public Cell updateCell(Cell cell) throws SystemException {
		return cellPersistence.update(cell);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("org.gfbio.model.Cell",
			cellLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"org.gfbio.model.Cell");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = cellPersistence.getDataSource();
	...
	private CellLocalServiceClpInvoker _clpInvoker = new CellLocalServiceClpInvoker();
}