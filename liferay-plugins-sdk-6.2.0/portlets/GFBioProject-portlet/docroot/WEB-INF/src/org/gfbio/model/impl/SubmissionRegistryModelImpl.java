...
/**
 * The base model implementation for the SubmissionRegistry service. Represents a row in the &quot;gfbio_SubmissionRegistry&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This implementation and its corresponding interface {@link org.gfbio.model.SubmissionRegistryModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link SubmissionRegistryImpl}.
 * </p>
 *
 * @author Marcel Froemming
 * @see SubmissionRegistryImpl
 * @see org.gfbio.model.SubmissionRegistry
 * @see org.gfbio.model.SubmissionRegistryModel
 * @generated
 */
@JSON(strict = true)
public class SubmissionRegistryModelImpl extends BaseModelImpl<SubmissionRegistry>
	implements SubmissionRegistryModel {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. All methods that expect a submission registry model instance should use the {@link org.gfbio.model.SubmissionRegistry} interface instead.
	 */
	...
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.entity.cache.enabled.org.gfbio.model.SubmissionRegistry"),
			false);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.finder.cache.enabled.org.gfbio.model.SubmissionRegistry"),
			false);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.column.bitmask.enabled.org.gfbio.model.SubmissionRegistry"),
			true);
	 ...
	 */
	public static SubmissionRegistry toModel(SubmissionRegistrySoap soapModel) {
		if (soapModel == null) {
			return null;
		}
	 ...
	 */
	public static List<SubmissionRegistry> toModels(
		SubmissionRegistrySoap[] soapModels) {
		if (soapModels == null) {
			return null;
		}

		List<SubmissionRegistry> models = new ArrayList<SubmissionRegistry>(soapModels.length);

		for (SubmissionRegistrySoap soapModel : soapModels) {
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.util.service.ServiceProps.get(
				"lock.expiration.time.org.gfbio.model.SubmissionRegistry"));

	public SubmissionRegistryModelImpl() {
	}
	...
	public Object clone() {
		...
		submissionRegistryImpl.setBrokerSubmissionID(getBrokerSubmissionID());
		submissionRegistryImpl.setArchivePID(getArchivePID());
		submissionRegistryImpl.setArchivePIDType(getArchivePIDType());
		submissionRegistryImpl.setLastChanged(getLastChanged());
		submissionRegistryImpl.setUserID(getUserID());
		submissionRegistryImpl.setIsPublic(getIsPublic());
		submissionRegistryImpl.setPublicAfter(getPublicAfter());
		submissionRegistryImpl.setStatus(getStatus());
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof SubmissionRegistry)) {
			return false;
		}
	...
	public void resetOriginalValues() {
		SubmissionRegistryModelImpl submissionRegistryModelImpl = this;

		submissionRegistryModelImpl._originalResearchObjectID = submissionRegistryModelImpl._researchObjectID;

		submissionRegistryModelImpl._setOriginalResearchObjectID = false;

		submissionRegistryModelImpl._originalResearchObjectVersion = submissionRegistryModelImpl._researchObjectVersion;

		submissionRegistryModelImpl._setOriginalResearchObjectVersion = false;

		submissionRegistryModelImpl._originalArchive = submissionRegistryModelImpl._archive;

		submissionRegistryModelImpl._originalBrokerSubmissionID = submissionRegistryModelImpl._brokerSubmissionID;

		submissionRegistryModelImpl._originalArchivePID = submissionRegistryModelImpl._archivePID;

		submissionRegistryModelImpl._originalArchivePIDType = submissionRegistryModelImpl._archivePIDType;

		submissionRegistryModelImpl._setOriginalArchivePIDType = false;

		submissionRegistryModelImpl._originalLastChanged = submissionRegistryModelImpl._lastChanged;

		submissionRegistryModelImpl._originalUserID = submissionRegistryModelImpl._userID;

		submissionRegistryModelImpl._setOriginalUserID = false;

		submissionRegistryModelImpl._originalIsPublic = submissionRegistryModelImpl._isPublic;

		submissionRegistryModelImpl._setOriginalIsPublic = false;

		submissionRegistryModelImpl._originalStatus = submissionRegistryModelImpl._status;

		submissionRegistryModelImpl._columnBitmask = 0;
	}
	...
	public CacheModel<SubmissionRegistry> toCacheModel() {
		...
		submissionRegistryCacheModel.researchObjectVersion = getResearchObjectVersion();

		submissionRegistryCacheModel.archive = getArchive();

		String archive = submissionRegistryCacheModel.archive;

		if ((archive != null) && (archive.length() == 0)) {
			submissionRegistryCacheModel.archive = null;
		}

		submissionRegistryCacheModel.brokerSubmissionID = getBrokerSubmissionID();

		String brokerSubmissionID = submissionRegistryCacheModel.brokerSubmissionID;

		if ((brokerSubmissionID != null) && (brokerSubmissionID.length() == 0)) {
			submissionRegistryCacheModel.brokerSubmissionID = null;
		}

		submissionRegistryCacheModel.archivePID = getArchivePID();

		String archivePID = submissionRegistryCacheModel.archivePID;

		if ((archivePID != null) && (archivePID.length() == 0)) {
			submissionRegistryCacheModel.archivePID = null;
		}

		submissionRegistryCacheModel.archivePIDType = getArchivePIDType();

		Date lastChanged = getLastChanged();

		if (lastChanged != null) {
			submissionRegistryCacheModel.lastChanged = lastChanged.getTime();
		}
		else {
			submissionRegistryCacheModel.lastChanged = Long.MIN_VALUE;
		}

		submissionRegistryCacheModel.userID = getUserID();

		submissionRegistryCacheModel.isPublic = getIsPublic();

		Date publicAfter = getPublicAfter();

		if (publicAfter != null) {
			submissionRegistryCacheModel.publicAfter = publicAfter.getTime();
		}
		else {
			submissionRegistryCacheModel.publicAfter = Long.MIN_VALUE;
		}

		submissionRegistryCacheModel.status = getStatus();

		String status = submissionRegistryCacheModel.status;

		if ((status != null) && (status.length() == 0)) {
			submissionRegistryCacheModel.status = null;
		}

		return submissionRegistryCacheModel;
	}
	...
	private static ClassLoader _classLoader = SubmissionRegistry.class.getClassLoader();
	...
	private SubmissionRegistry _escapedModel;
}