...
public class ProjectModelImpl extends BaseModelImpl<Project>
	...
	public static final String TABLE_SQL_CREATE = "create table gfbio_Project (projectID LONG not null primary key,name VARCHAR(75) null,description VARCHAR(75) null,begin DATE null,end_ DATE null,status VARCHAR(75) null)";
	...
	public Object clone() {
		...
		projectImpl.setBegin(getBegin());
		projectImpl.setEnd(getEnd());
	...
	public CacheModel<Project> toCacheModel() {
		...
		if (begin != null) {
			projectCacheModel.begin = begin.getTime();
		}
		else {
			projectCacheModel.begin = Long.MIN_VALUE;
		}

		Date end = getEnd();

		if (end != null) {
			projectCacheModel.end = end.getTime();
		}
		else {
			projectCacheModel.end = Long.MIN_VALUE;
		}
