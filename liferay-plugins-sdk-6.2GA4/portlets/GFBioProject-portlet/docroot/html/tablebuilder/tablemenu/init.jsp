<script>
			...
			async: false,
 			success :  function (obj){
				...
				for (i =0; i <obj.length;i++){
					var json = obj[i];
					//addColumnBlock ('tableBuilder', json, json, json);
					//addStandardBlock ('tableBuilder', json, json, 'A description will come.', json);
					var description ='A description will come. A description will come. A description will come. A description will come. A description will come. A description will come. A description will come. A description will come. A description will come. A description will come.';
					var columnList = 'A list of colums. A list of colums. ';
					console.log(targetId);
					addListBlock ('tableBuilder', json, json, 'Column: ',columnList, 'Description: ',description, 'buildTableEdit("'+json+'","'+targetId+'")');
				}
 			}
 		});
	}
	...
	//
	function buildTableEdit(data, targetId){
