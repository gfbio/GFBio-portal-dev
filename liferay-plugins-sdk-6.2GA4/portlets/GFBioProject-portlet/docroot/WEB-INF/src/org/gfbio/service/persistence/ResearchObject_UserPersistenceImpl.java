...
public class ResearchObject_UserPersistenceImpl extends BasePersistenceImpl<ResearchObject_User>
	...
	public ResearchObject_User findByfindByPrimaryKey(long researchObjectID,
		long userID) throws NoSuchResearchObject_UserException, SystemException {
	...
	public ResearchObject_User fetchByfindByPrimaryKey(long researchObjectID,
		...
		return fetchByfindByPrimaryKey(researchObjectID, userID, true);
	}
	...
	public ResearchObject_User fetchByfindByPrimaryKey(long researchObjectID,
		...
		Object[] finderArgs = new Object[] { researchObjectID, userID };
			...
			try {
				...
				if (list.isEmpty()) {
					...
					if ((list.size() > 1) && _log.isWarnEnabled()) {
						_log.warn(
							"ResearchObject_UserPersistenceImpl.fetchByfindByPrimaryKey(long, long, boolean) with parameters (" +
