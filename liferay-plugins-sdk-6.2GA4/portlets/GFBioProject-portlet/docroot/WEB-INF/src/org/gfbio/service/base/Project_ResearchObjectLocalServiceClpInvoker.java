...
public class Project_ResearchObjectLocalServiceClpInvoker {
	public Project_ResearchObjectLocalServiceClpInvoker() {
		...
		_methodName150 = "getProjectIDList";

		_methodParameterTypes150 = new String[] { "long" };

		_methodName151 = "getResearchObjectsByProjectId";

		_methodParameterTypes151 = new String[] { "long" };

		_methodName152 = "checkResearchObjectIdAndVersion";

		_methodParameterTypes152 = new String[] { "long", "int" };

		_methodName153 = "updateProjectResearchObject";
