...
/**
 * Provides the local service interface for Funding_InstitutionProject. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Marcel Froemming
 * @see Funding_InstitutionProjectLocalServiceUtil
...
public interface Funding_InstitutionProjectLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link Funding_InstitutionProjectLocalServiceUtil} to access the funding_ institution project local service. Add custom service methods to {@link org.gfbio.service.impl.Funding_InstitutionProjectLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
