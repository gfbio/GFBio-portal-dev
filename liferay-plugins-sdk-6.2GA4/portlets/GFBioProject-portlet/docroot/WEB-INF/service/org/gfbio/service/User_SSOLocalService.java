...
/**
 * Provides the local service interface for User_SSO. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Marcel Froemming
 * @see User_SSOLocalServiceUtil
...
public interface User_SSOLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link User_SSOLocalServiceUtil} to access the user_ s s o local service. Add custom service methods to {@link org.gfbio.service.impl.User_SSOLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
