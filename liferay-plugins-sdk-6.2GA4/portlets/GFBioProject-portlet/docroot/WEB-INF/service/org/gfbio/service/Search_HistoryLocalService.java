...
/**
 * Provides the local service interface for Search_History. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Marcel Froemming
 * @see Search_HistoryLocalServiceUtil
...
public interface Search_HistoryLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link Search_HistoryLocalServiceUtil} to access the search_ history local service. Add custom service methods to {@link org.gfbio.service.impl.Search_HistoryLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
