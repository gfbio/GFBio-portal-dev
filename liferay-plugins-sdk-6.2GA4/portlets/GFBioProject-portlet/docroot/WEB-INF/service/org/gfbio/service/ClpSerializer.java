...
import org.gfbio.model.SearchHistoryClp;
...
public class ClpSerializer {
	...
	public static Object translateInput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals(SearchHistoryClp.class.getName())) {
			return translateInputSearchHistory(oldModel);
		}
	...
	public static Object translateInputSearchHistory(BaseModel<?> oldModel) {
		SearchHistoryClp oldClpModel = (SearchHistoryClp)oldModel;

		BaseModel<?> newModel = oldClpModel.getSearchHistoryRemoteModel();
	...
	public static Object translateOutput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals("org.gfbio.model.impl.SearchHistoryImpl")) {
			return translateOutputSearchHistory(oldModel);
		}
		else if (oldModelClassName.endsWith("Clp")) {
			try {
				ClassLoader classLoader = ClpSerializer.class.getClassLoader();
	...
	public static Throwable translateThrowable(Throwable throwable) {
		...
		if (className.equals("org.gfbio.NoSuchSearchHistoryException")) {
			return new org.gfbio.NoSuchSearchHistoryException();
		}
	...
	public static Object translateOutputSearchHistory(BaseModel<?> oldModel) {
		SearchHistoryClp newModel = new SearchHistoryClp();

		newModel.setModelAttributes(oldModel.getModelAttributes());

		newModel.setSearchHistoryRemoteModel(oldModel);
