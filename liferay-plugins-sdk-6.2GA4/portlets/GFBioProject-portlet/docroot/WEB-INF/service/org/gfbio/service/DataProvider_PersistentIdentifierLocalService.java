...
/**
 * Provides the local service interface for DataProvider_PersistentIdentifier. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Marcel Froemming
 * @see DataProvider_PersistentIdentifierLocalServiceUtil
...
public interface DataProvider_PersistentIdentifierLocalService
	extends BaseLocalService, InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link DataProvider_PersistentIdentifierLocalServiceUtil} to access the data provider_ persistent identifier local service. Add custom service methods to {@link org.gfbio.service.impl.DataProvider_PersistentIdentifierLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
