...
public class Project_ResearchObjectLocalServiceClpInvoker {
	public Project_ResearchObjectLocalServiceClpInvoker() {
		...
		_methodName168 = "getProjectIdsByResearchObject";

		_methodParameterTypes168 = new String[] { "org.json.simple.JSONObject" };

		_methodName169 = "getProjectIDList";

		_methodParameterTypes169 = new String[] { "long" };

		_methodName171 = "getResearchObjectsByProjectId";

		_methodParameterTypes171 = new String[] { "long" };

		_methodName172 = "checkResearchObjectIdAndVersion";

		_methodParameterTypes172 = new String[] { "long", "int" };

		_methodName173 = "updateProjectResearchObject";
