...
public class SubmissionServiceSoap {
	...
	public static org.json.simple.JSONArray getStatusByResearchObjectId(
		org.json.simple.JSONObject requestJson) throws RemoteException {
		try {
			org.json.simple.JSONArray returnValue = SubmissionServiceUtil.getStatusByResearchObjectId(requestJson);
	...
	public static org.json.simple.JSONArray getStatusByResearchObjectIdAndVersion(
		org.json.simple.JSONObject requestJson) throws RemoteException {
		try {
			org.json.simple.JSONArray returnValue = SubmissionServiceUtil.getStatusByResearchObjectIdAndVersion(requestJson);
	...
	public static org.json.simple.JSONArray getSubmissionsByResearchObjectIdAndVersion(
		org.json.simple.JSONObject requestJson) throws RemoteException {
		try {
			org.json.simple.JSONArray returnValue = SubmissionServiceUtil.getSubmissionsByResearchObjectIdAndVersion(requestJson);
