...
public class UserExtensionServiceClpInvoker {
	public UserExtensionServiceClpInvoker() {
		...
		_methodName152 = "getUserByEmailAddress";

		_methodParameterTypes152 = new String[] { "org.json.simple.JSONObject" };

		_methodName153 = "getUserById";
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName152.equals(name) &&
			...
			return UserExtensionServiceUtil.getUserByEmailAddress((org.json.simple.JSONObject)arguments[0]);
		}
