...
public class BasketLocalServiceClpInvoker {
	public BasketLocalServiceClpInvoker() {
		...
		_methodName168 = "getBasketById";

		_methodParameterTypes168 = new String[] { "long" };

		_methodName169 = "getBasketsByIds";

		_methodParameterTypes169 = new String[] { "long[][]" };

		_methodName170 = "getBasketsByUserAndPeriod";

		_methodParameterTypes170 = new String[] { "long", "int" };

		_methodName171 = "getBasketsByUserId";

		_methodParameterTypes171 = new String[] { "long" };

		_methodName172 = "getBasketsIdByUserAndPeriod";

		_methodParameterTypes172 = new String[] { "long", "int" };

		_methodName173 = "getBasketsIdByUserId";
		...
		_methodName176 = "getStartDateFromPeriod";
