...
public class UserExtensionServiceSoap {
	...
	* @JSONWebService
	*/
	public static org.json.simple.JSONObject getUserByEmailAddress(
		org.json.simple.JSONObject requestJson) throws RemoteException {
		try {
			org.json.simple.JSONObject returnValue = UserExtensionServiceUtil.getUserByEmailAddress(requestJson);
	...
	*/
	public static org.json.simple.JSONObject getUserById(
		org.json.simple.JSONObject requestJson) throws RemoteException {
		try {
			org.json.simple.JSONObject returnValue = UserExtensionServiceUtil.getUserById(requestJson);
