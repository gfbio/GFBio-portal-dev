...
public class ProjectServiceSoap {
	public static org.json.simple.JSONObject getCheckProjectOnSubmissions(
		org.json.simple.JSONObject requestJson) throws RemoteException {
		try {
			org.json.simple.JSONObject returnValue = ProjectServiceUtil.getCheckProjectOnSubmissions(requestJson);
	...
	public static org.json.simple.JSONArray getProjectsByUser(
		org.json.simple.JSONObject requestJson) throws RemoteException {
		try {
			org.json.simple.JSONArray returnValue = ProjectServiceUtil.getProjectsByUser(requestJson);
