...
public class ProjectLocalServiceWrapper implements ProjectLocalService,
	...
	*/
	...
	public org.json.simple.JSONArray getProjectsByUser(
		org.json.simple.JSONObject requestJson) {
		return _projectLocalService.getProjectsByUser(requestJson);
	}

	@Override
	public org.json.simple.JSONArray getUserIdsByResearchObject(
		org.json.simple.JSONObject requestJson) {
		return _projectLocalService.getUserIdsByResearchObject(requestJson);
	}
	...
	public org.json.simple.JSONObject checkProjectOnSubmissions(
		...
		return _projectLocalService.checkProjectOnSubmissions(idJson);
	}
	...
	public long constructNewId() {
		return _projectLocalService.constructNewId();
	}

	@Override
	public org.json.simple.JSONObject constructReducedProjectAsJson(
		org.gfbio.model.Project project) {
		return _projectLocalService.constructReducedProjectAsJson(project);
	}
