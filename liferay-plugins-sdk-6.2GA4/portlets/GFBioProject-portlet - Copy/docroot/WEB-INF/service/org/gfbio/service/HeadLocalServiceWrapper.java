...
public class HeadLocalServiceWrapper implements HeadLocalService,
	...
	*/
	...
	public org.json.simple.JSONArray getTableNamesByTableType(
		...
		return _headLocalService.getTableNamesByTableType(requestJson);
	}
	...
	public org.json.simple.JSONArray getTableNamesByTableType(
		java.lang.String tableType) {
		return _headLocalService.getTableNamesByTableType(tableType);
	}

	@Override
	public org.json.simple.JSONObject constructHeadJson(
		org.gfbio.model.Head head) {
		return _headLocalService.constructHeadJson(head);
	}
	...
	public org.json.simple.JSONObject constructHeadJson(long headId,
		...
		return _headLocalService.constructHeadJson(headId, tableName,
			tableType, lastModifiedDate);
	}
	...
	public long constructNewId() {
		return _headLocalService.constructNewId();
	}
