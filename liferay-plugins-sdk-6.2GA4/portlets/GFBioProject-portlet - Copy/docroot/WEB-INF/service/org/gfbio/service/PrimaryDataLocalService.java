...
/**
 * Provides the local service interface for PrimaryData. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Marcel Froemming
 * @see PrimaryDataLocalServiceUtil
...
public interface PrimaryDataLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link PrimaryDataLocalServiceUtil} to access the primary data local service. Add custom service methods to {@link org.gfbio.service.impl.PrimaryDataLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
