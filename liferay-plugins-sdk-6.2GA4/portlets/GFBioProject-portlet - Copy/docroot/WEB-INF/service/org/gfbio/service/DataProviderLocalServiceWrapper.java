...
public class DataProviderLocalServiceWrapper implements DataProviderLocalService,
	...
	*/
	...
	public java.util.List<org.gfbio.model.DataProvider> getDataProviderByProviderType(
		...
		return _dataProviderLocalService.getDataProviderByProviderType(providerType);
	}
	...
	public long constructNewId() {
		return _dataProviderLocalService.constructNewId();
	}
	...
	public java.lang.Boolean updateDataProvider(long dataProviderId,
		...
		return _dataProviderLocalService.updateDataProvider(dataProviderId,
			name, label, description, address, website, training,
			physicalObjectPossible, noPhysicalObject, taxonBased, noTaxonBased,
			livingObjects, deadObjects, sequenceData);
	}
