...
public class DataProviderLocalServiceUtil {
	...
	*/
	...
	public static java.util.List<org.gfbio.model.DataProvider> getDataProviderByProviderType(
		java.lang.String providerType) {
		return getService().getDataProviderByProviderType(providerType);
	}
	...
	public static java.lang.Boolean updateDataProvider(long dataProviderId,
		...
		return getService()
				   .updateDataProvider(dataProviderId, name, label,
			description, address, website, training, physicalObjectPossible,
			noPhysicalObject, taxonBased, noTaxonBased, livingObjects,
			deadObjects, sequenceData);
	}
