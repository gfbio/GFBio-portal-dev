...
public class SubmissionFinderUtil {
	public static java.util.List getArchiveById(long submissionId) {
		return getFinder().getArchiveById(submissionId);
	}
	...
	public static java.util.List<java.lang.String> getBrokerSubmissionIdByIds(
	...
	public static java.util.List<java.lang.Boolean> getCheckOfBrokerSubmissionId(
		java.lang.String brokersubmissionid) {
		return getFinder().getCheckOfBrokerSubmissionId(brokersubmissionid);
	}

	public static java.util.List<java.lang.Boolean> getCheckOfIds(
		long researchObjectId, int researchObjectVersion,
		java.lang.String archive) {
		return getFinder()
				   .getCheckOfIds(researchObjectId, researchObjectVersion,
			archive);
	}

	public static java.util.List<java.lang.Boolean> getCheckOfSubmissionId(
		long submissionid) {
		return getFinder().getCheckOfSubmissionId(submissionid);
	}
	...
	public static java.util.List getSubmissionIdsByBrokerSubmissionId(
		java.lang.String brokerSubmissionId) {
		return getFinder()
				   .getSubmissionIdsByBrokerSubmissionId(brokerSubmissionId);
	}
	...
	public static java.util.List getSubmissionIdsByResearchObjectIdAndVersion(
		long researchObjectId, int researchObjectVersion) {
		return getFinder()
				   .getSubmissionIdsByResearchObjectIdAndVersion(researchObjectId,
			researchObjectVersion);
	}
