...
public interface SubmissionFinder {
	public java.util.List getArchiveById(long submissionId);
	...
	public java.util.List<java.lang.String> getBrokerSubmissionIdByIds(
		long researchObjectId, int researchObjectVersion,
		java.lang.String archive);

	public java.util.List<java.lang.Boolean> getCheckOfBrokerSubmissionId(
		java.lang.String brokersubmissionid);

	public java.util.List<java.lang.Boolean> getCheckOfIds(
		long researchObjectId, int researchObjectVersion,
		java.lang.String archive);

	public java.util.List<java.lang.Boolean> getCheckOfSubmissionId(
		long submissionid);
	...
	public java.util.List getSubmissionIdsByBrokerSubmissionId(
		java.lang.String brokerSubmissionId);

	public java.util.List getSubmissionIdByIds(long researchObjectId,
		int researchObjectVersion, java.lang.String archive);

	public java.util.List getSubmissionIdsByResearchObjectIdAndVersion(
		long researchObjectId, int researchObjectVersion);
}