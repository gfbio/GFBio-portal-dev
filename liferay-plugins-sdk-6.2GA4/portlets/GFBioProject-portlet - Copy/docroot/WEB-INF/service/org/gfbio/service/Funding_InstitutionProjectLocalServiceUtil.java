...
public class Funding_InstitutionProjectLocalServiceUtil {
	...
	*/
	...
	public static org.json.simple.JSONObject createFundingInstitutionProject(
		org.json.simple.JSONObject requestJson) {
		return getService().createFundingInstitutionProject(requestJson);
	}

	public static java.lang.Boolean saveUpdateFundingInstitutionProject(
		long projectId, long fundingAgencyId, long fundingProgramId,
		long institutionId) {
		return getService()
				   .saveUpdateFundingInstitutionProject(projectId,
			fundingAgencyId, fundingProgramId, institutionId);
	}

	public static java.lang.Boolean updateFundingInstitutionProject(
		long projectId, long fundingAgencyId, long fundingProgramId,
		long institutionId) {
		return getService()
				   .updateFundingInstitutionProject(projectId, fundingAgencyId,
			fundingProgramId, institutionId);
	}
