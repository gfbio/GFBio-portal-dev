...
public class SubmissionLocalServiceWrapper implements SubmissionLocalService,
	...
	*/
	...
	public org.json.simple.JSONObject deleteSubmission(
		...
		return _submissionLocalService.deleteSubmission(requestJson);
	}

	@Override
	public org.json.simple.JSONObject getBrokerSubmissionId(
		org.json.simple.JSONObject requestJson) {
		return _submissionLocalService.getBrokerSubmissionId(requestJson);
	}
	...
	public org.json.simple.JSONArray getStatusByResearchObjectId(
		org.json.simple.JSONObject requestJson) {
		return _submissionLocalService.getStatusByResearchObjectId(requestJson);
	}

	@Override
	public org.json.simple.JSONArray getStatusByResearchObjectIdAndVersion(
		org.json.simple.JSONObject requestJson) {
		return _submissionLocalService.getStatusByResearchObjectIdAndVersion(requestJson);
	}
	...
	public org.json.simple.JSONArray getSubmissionsByResearchObjectIdAndVersion(
		org.json.simple.JSONObject requestJson) {
		return _submissionLocalService.getSubmissionsByResearchObjectIdAndVersion(requestJson);
	}

	@Override
	public org.json.simple.JSONArray getSubmissionIdsByResearchObjectIdAndVersion(
		org.json.simple.JSONObject requestJson) {
		return _submissionLocalService.getSubmissionIdsByResearchObjectIdAndVersion(requestJson);
	}
	...
	public java.lang.String getBrokerSubmissionIdByIds(long researchObjectId,
		...
		return _submissionLocalService.getBrokerSubmissionIdByIds(researchObjectId,
	...
	public java.lang.Boolean checkOfIds(long researchObjectId,
		int researchObjectVersion, java.lang.String archive) {
		return _submissionLocalService.checkOfIds(researchObjectId,
			researchObjectVersion, archive);
	}

	@Override
	public java.lang.Boolean checkOfSubmissionId(long submissionId) {
		return _submissionLocalService.checkOfSubmissionId(submissionId);
	}

	@Override
	public java.lang.Boolean checkOfBrokerSubmissionId(
		java.lang.String brokersubmissionid) {
		return _submissionLocalService.checkOfBrokerSubmissionId(brokersubmissionid);
	}

	@Override
	public java.lang.Boolean checkResearchObjectIdAndVersion(
		long researchObjectId, int researchObjectVersion) {
		return _submissionLocalService.checkResearchObjectIdAndVersion(researchObjectId,
			researchObjectVersion);
	}

	@Override
	public long constructNewId() {
		return _submissionLocalService.constructNewId();
	}
	...
	public java.lang.Boolean updateJiraId(long researchObjectId,
		...
		return _submissionLocalService.updateJiraId(researchObjectId,
			researchObjectVersion, archive, jiraId);
	}
	...
	public java.lang.Boolean updateJiraKey(long researchObjectId,
		...
		return _submissionLocalService.updateJiraKey(researchObjectId,
			researchObjectVersion, archive, jiraKey);
	}
