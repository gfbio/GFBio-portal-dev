...
import org.gfbio.service.PrimaryDataServiceUtil;
import org.gfbio.service.PrimaryData_ResearchObjectLocalServiceUtil;
import org.gfbio.service.PrimaryData_ResearchObjectServiceUtil;
...
public class ClpMessageListener extends BaseMessageListener {
	...
	protected void doReceive(Message message) throws Exception {
		...
		if (command.equals("undeploy") &&
			...
			PrimaryDataLocalServiceUtil.clearService();

			PrimaryDataServiceUtil.clearService();
			PrimaryData_ResearchObjectLocalServiceUtil.clearService();

			PrimaryData_ResearchObjectServiceUtil.clearService();
			...
			ResearchObject_UserLocalServiceUtil.clearService();

			ResearchObject_UserServiceUtil.clearService();
			...
			UserSSOLocalServiceUtil.clearService();

			UserSSOServiceUtil.clearService();
		}
	}
}