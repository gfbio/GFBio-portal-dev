...
public class UserExtensionLocalServiceUtil {
	...
	*/
	...
	public static org.json.simple.JSONObject getUserExtentionByEmailAddress(
		org.json.simple.JSONObject requestJson) {
		return getService().getUserExtentionByEmailAddress(requestJson);
	}
	...
	public static java.lang.Boolean checkExistenceOfUserMail(
		java.lang.String eMailAddress) {
		return getService().checkExistenceOfUserMail(eMailAddress);
	}
