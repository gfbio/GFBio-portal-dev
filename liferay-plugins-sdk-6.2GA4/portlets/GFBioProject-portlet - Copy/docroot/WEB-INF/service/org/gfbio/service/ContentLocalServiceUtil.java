...
public class ContentLocalServiceUtil {
	...
	*/
	...
	public static void deleteRelationContentsByCellContent(
		java.lang.String relationTable, java.lang.String columnName,
		java.lang.String cellContent) {
		getService()
			.deleteRelationContentsByCellContent(relationTable, columnName,
			cellContent);
	}

	public static void deleteRelationContentOfCategoryWithSpecificType(
		java.lang.String typeName, long relatedId,
		java.lang.String relationTable) {
		getService()
			.deleteRelationContentOfCategoryWithSpecificType(typeName,
			relatedId, relationTable);
	}
	...
	public static long getContentIdByRowIdAndColumnName(long rowId,
		java.lang.String columnName) {
		return getService().getContentIdByRowIdAndColumnName(rowId, columnName);
	}
	...
	public static long getHeadIdByRowId(long rowId) {
		return getService().getHeadIdByRowId(rowId);
	}
	...
	public static org.json.simple.JSONArray getRowInformationOfRelationshipsOfSpecificCellContent(
		long relationTableHeadId, long entitiyTableHeadId,
		java.lang.String entityTableCellContent) {
		return getService()
				   .getRowInformationOfRelationshipsOfSpecificCellContent(relationTableHeadId,
			entitiyTableHeadId, entityTableCellContent);
	}
	...
	public static org.json.simple.JSONObject constructContentJson(
		org.gfbio.model.Content content) {
		return getService().constructContentJson(content);
	}

	public static org.json.simple.JSONObject constructContentJson(
		long contentId, long headId, long columnId, long rowId,
		java.lang.String cellContent, java.util.Date lastModifiedDate) {
		return getService()
				   .constructContentJson(contentId, headId, columnId, rowId,
			cellContent, lastModifiedDate);
	}

	public static org.json.simple.JSONArray constructContenRowInputJson(
		java.lang.String tableName, long contentId, long rowId,
		org.json.simple.JSONObject rowInformationJson) {
		return getService()
				   .constructContenRowInputJson(tableName, contentId, rowId,
			rowInformationJson);
	}
	...
	public static org.json.simple.JSONArray createContent(
		org.json.simple.JSONObject requestJson) {
		return getService().createContent(requestJson);
	}

	public static org.json.simple.JSONArray createContentWithTS(
		org.json.simple.JSONObject requestJson) {
		return getService().createContentWithTS(requestJson);
	}

	public static org.json.simple.JSONArray createContentRow(
		org.json.simple.JSONArray requestJson) {
		return getService().createContentRow(requestJson);
	}

	public static org.json.simple.JSONArray updateContent(
		org.json.simple.JSONObject requestJson) {
		return getService().updateContent(requestJson);
	}

	public static org.json.simple.JSONArray updateContentWithTS(
		org.json.simple.JSONObject requestJson) {
		return getService().updateContentWithTS(requestJson);
	}

	public static org.json.simple.JSONArray updateContentRow(
		org.json.simple.JSONArray requestJson) {
		return getService().updateContentRow(requestJson);
	}

	public static long updateKernalContent(long headId, long columnId,
		long contentId, java.lang.String cellContent) {
		return getService()
				   .updateKernalContent(headId, columnId, contentId, cellContent);
	}

	public static long updateKernelContent(long headId, long columnId,
		long contentId, long rowId, java.lang.String cellContent) {
		return getService()
				   .updateKernelContent(headId, columnId, contentId, rowId,
			cellContent);
	}

	public static long updateRowTimeStamp(long headId, long rowId,
		long contentId) {
		return getService().updateRowTimeStamp(headId, rowId, contentId);
	}

	public static org.json.simple.JSONObject updateContent(long headId,
		long columnId, long contentId, long rowId,
		java.lang.String cellContent, long tsContentId) {
		return getService()
				   .updateContent(headId, columnId, contentId, rowId,
			cellContent, tsContentId);
	}

	public static long updateContent2(org.json.simple.JSONObject json) {
