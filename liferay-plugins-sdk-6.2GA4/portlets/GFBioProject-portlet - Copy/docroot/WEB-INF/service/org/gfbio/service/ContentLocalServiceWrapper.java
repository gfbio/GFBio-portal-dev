...
public class ContentLocalServiceWrapper implements ContentLocalService,
	...
	*/
	...
	public void deleteRelationContentsByCellContent(
		...
		_contentLocalService.deleteRelationContentsByCellContent(relationTable,
	...
	public void deleteRelationContentOfCategoryWithSpecificType(
		...
		_contentLocalService.deleteRelationContentOfCategoryWithSpecificType(typeName,
	...
	public long getContentIdByRowIdAndColumnName(long rowId,
		java.lang.String columnName) {
		return _contentLocalService.getContentIdByRowIdAndColumnName(rowId,
			columnName);
	}
	...
	public long getHeadIdByRowId(long rowId) {
		return _contentLocalService.getHeadIdByRowId(rowId);
	}
	...
	public org.json.simple.JSONArray getRowInformationOfRelationshipsOfSpecificCellContent(
		long relationTableHeadId, long entitiyTableHeadId,
		java.lang.String entityTableCellContent) {
		return _contentLocalService.getRowInformationOfRelationshipsOfSpecificCellContent(relationTableHeadId,
			entitiyTableHeadId, entityTableCellContent);
	}
	...
	public org.json.simple.JSONObject constructContentJson(
		org.gfbio.model.Content content) {
		return _contentLocalService.constructContentJson(content);
	}
	...
	public org.json.simple.JSONObject constructContentJson(long contentId,
		...
		return _contentLocalService.constructContentJson(contentId, headId,
			columnId, rowId, cellContent, lastModifiedDate);
	}
	...
	public org.json.simple.JSONArray constructContenRowInputJson(
		...
		return _contentLocalService.constructContenRowInputJson(tableName,
			contentId, rowId, rowInformationJson);
	}
	...
	public org.json.simple.JSONArray createContent(
		org.json.simple.JSONObject requestJson) {
		return _contentLocalService.createContent(requestJson);
	}

	@Override
	public org.json.simple.JSONArray createContentWithTS(
		org.json.simple.JSONObject requestJson) {
		return _contentLocalService.createContentWithTS(requestJson);
	}

	@Override
	public org.json.simple.JSONArray createContentRow(
		org.json.simple.JSONArray requestJson) {
		return _contentLocalService.createContentRow(requestJson);
	}

	@Override
	public org.json.simple.JSONArray updateContent(
		org.json.simple.JSONObject requestJson) {
		return _contentLocalService.updateContent(requestJson);
	}

	@Override
	public org.json.simple.JSONArray updateContentWithTS(
		org.json.simple.JSONObject requestJson) {
		return _contentLocalService.updateContentWithTS(requestJson);
	}

	@Override
	public org.json.simple.JSONArray updateContentRow(
		org.json.simple.JSONArray requestJson) {
		return _contentLocalService.updateContentRow(requestJson);
	}

	@Override
	public long updateKernalContent(long headId, long columnId, long contentId,
		java.lang.String cellContent) {
		return _contentLocalService.updateKernalContent(headId, columnId,
	...
	public long updateKernelContent(long headId, long columnId, long contentId,
		...
		return _contentLocalService.updateKernelContent(headId, columnId,
			contentId, rowId, cellContent);
	}

	@Override
	public long updateRowTimeStamp(long headId, long rowId, long contentId) {
		return _contentLocalService.updateRowTimeStamp(headId, rowId, contentId);
	}
	...
	public org.json.simple.JSONObject updateContent(long headId, long columnId,
		...
		long tsContentId) {
		return _contentLocalService.updateContent(headId, columnId, contentId,
			rowId, cellContent, tsContentId);
	}
