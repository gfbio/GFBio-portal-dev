	...
	*/
	...
	public static long updateBasket(long basketId, long userId,
		...
		return getService()
			...
			queryJSON, queryKeyword, queryFilter);
	}
	...
	public static java.lang.String getToken() throws java.lang.Exception {
		return getService().getToken();
	}

	public static long getLoggedInUserId() throws java.lang.Exception {
