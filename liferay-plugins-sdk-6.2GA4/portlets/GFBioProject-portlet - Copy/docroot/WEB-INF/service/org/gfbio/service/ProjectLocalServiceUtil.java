...
public class ProjectLocalServiceUtil {
	...
	*/
	...
	public static org.json.simple.JSONArray getProjectsByUser(
		org.json.simple.JSONObject requestJson) {
		return getService().getProjectsByUser(requestJson);
	}
	...
	public static org.json.simple.JSONObject checkProjectOnSubmissions(
		org.json.simple.JSONObject idJson) {
		return getService().checkProjectOnSubmissions(idJson);
	}
	...
	public static org.json.simple.JSONObject constructReducedProjectAsJson(
		org.gfbio.model.Project project) {
		return getService().constructReducedProjectAsJson(project);
	}
