...
public class ResearchObjectLocalServiceUtil {
	...
	*/
	...
	public static org.json.simple.JSONObject getAllUserIdsByResearchObject(
		org.json.simple.JSONObject requestJson) {
		return getService().getAllUserIdsByResearchObject(requestJson);
	}
	...
	public static org.json.simple.JSONArray getResearchObjectInformationByUserId(
		org.json.simple.JSONObject requestJson) {
		return getService().getResearchObjectInformationByUserId(requestJson);
	}
	...
	public static org.json.simple.JSONArray getResearchObjectsByUserId(
		long userId) {
	...
	public static org.json.simple.JSONArray getResearchObjectInformationByUserId(
		long userId) {
		return getService().getResearchObjectInformationByUserId(userId);
	}
	...
	public static java.util.List<java.lang.Integer> getResearchObjectVersionsById(
		long researchObjectId) {
		return getService().getResearchObjectVersionsById(researchObjectId);
	}

	public static int getResearchObjectVersionFromJson(
		org.json.simple.JSONObject requestJson) {
		return getService().getResearchObjectVersionFromJson(requestJson);
	}
	...
	public static org.json.simple.JSONArray getUserIdsByIds(
		long researchObjectId, int researchObjectVersion) {
		return getService()
				   .getUserIdsByIds(researchObjectId, researchObjectVersion);
	}
	...
	public static org.json.simple.JSONObject constructExtendedResearchObjectJson(
		org.gfbio.model.ResearchObject researchObject) {
		return getService().constructExtendedResearchObjectJson(researchObject);
	}
