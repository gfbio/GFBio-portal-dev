...
public class ResearchObjectFinderUtil {
	...
	public static java.util.List getResearchObjectInformationByUserId(
		long userId) {
		return getFinder().getResearchObjectInformationByUserId(userId);
	}

	public static java.util.List getResearchObjectVersionsById(
		long researchObjectId) {
		return getFinder().getResearchObjectVersionsById(researchObjectId);
	}
