...
public class HeadLocalServiceUtil {
	...
	*/
	...
	public static org.json.simple.JSONArray getTableNamesByTableType(
		org.json.simple.JSONObject requestJson) {
		return getService().getTableNamesByTableType(requestJson);
	}
	...
	public static org.json.simple.JSONArray getTableNamesByTableType(
		java.lang.String tableType) {
		return getService().getTableNamesByTableType(tableType);
	}

	public static org.json.simple.JSONObject constructHeadJson(
		org.gfbio.model.Head head) {
		return getService().constructHeadJson(head);
	}
	...
	public static org.json.simple.JSONObject constructHeadJson(long headId,
		...
		return getService()
				   .constructHeadJson(headId, tableName, tableType,
			lastModifiedDate);
	}
