...
public class ResearchObjectLocalServiceWrapper
	...
	*/
	...
	public org.json.simple.JSONObject deleteSubmission(
		...
		return _researchObjectLocalService.deleteSubmission(requestJson);
	}

	@Override
	public org.json.simple.JSONObject getAllUserIdsByResearchObject(
		org.json.simple.JSONObject requestJson) {
		return _researchObjectLocalService.getAllUserIdsByResearchObject(requestJson);
	}

	@Override
	public org.json.simple.JSONArray getResearchObjectsAsJsonById(
		org.json.simple.JSONArray requestJson) {
		return _researchObjectLocalService.getResearchObjectsAsJsonById(requestJson);
	}
	...
	public org.json.simple.JSONArray getResearchObjectInformationByUserId(
		org.json.simple.JSONObject requestJson) {
		return _researchObjectLocalService.getResearchObjectInformationByUserId(requestJson);
	}

	@Override
	public org.json.simple.JSONArray getResearchObjectsByProjectId(
		long projectId) {
		return _researchObjectLocalService.getResearchObjectsByProjectId(projectId);
	}

	@Override
	public org.json.simple.JSONArray getResearchObjectsByUserId(long userId) {
		return _researchObjectLocalService.getResearchObjectsByUserId(userId);
	}
	...
	public org.json.simple.JSONArray getResearchObjectInformationByUserId(
		long userId) {
		return _researchObjectLocalService.getResearchObjectInformationByUserId(userId);
	}
	...
	public java.util.List<java.lang.Integer> getResearchObjectVersionsById(
		long researchObjectId) {
		return _researchObjectLocalService.getResearchObjectVersionsById(researchObjectId);
	}

	@Override
	public int getResearchObjectVersionFromJson(
		org.json.simple.JSONObject requestJson) {
		return _researchObjectLocalService.getResearchObjectVersionFromJson(requestJson);
	}
	...
	public org.json.simple.JSONArray getUserIdsByIds(long researchObjectId,
		int researchObjectVersion) {
		return _researchObjectLocalService.getUserIdsByIds(researchObjectId,
			researchObjectVersion);
	}
	...
	public long constructNewId() {
		return _researchObjectLocalService.constructNewId();
	}
	...
	public org.json.simple.JSONObject constructExtendedResearchObjectJson(
		org.gfbio.model.ResearchObject researchObject) {
		return _researchObjectLocalService.constructExtendedResearchObjectJson(researchObject);
	}
