...
public class ColumnLocalServiceWrapper implements ColumnLocalService,
	...
	*/
	...
	public long getColumnIdByNames(java.lang.String tableName,
		...
		return _columnLocalService.getColumnIdByNames(tableName, columnName);
	}
	...
	*/
	...
	public java.lang.Boolean checkExistenceOfColumn(
		...
		return _columnLocalService.checkExistenceOfColumn(tableName, columnName);
	}

	@Override
	public java.lang.Boolean checkExistenceOfColumn(long headId,
		java.lang.String columnName) {
		return _columnLocalService.checkExistenceOfColumn(headId, columnName);
	}
	...
	public org.json.simple.JSONObject constructColumnJson(
		...
		return _columnLocalService.constructColumnJson(column);
	}
	...
	public long constructNewId() {
		return _columnLocalService.constructNewId();
	}
