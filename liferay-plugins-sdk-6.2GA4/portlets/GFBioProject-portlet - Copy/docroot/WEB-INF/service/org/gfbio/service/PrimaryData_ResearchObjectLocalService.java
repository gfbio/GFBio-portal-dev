...
/**
 * Provides the local service interface for PrimaryData_ResearchObject. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Marcel Froemming
 * @see PrimaryData_ResearchObjectLocalServiceUtil
...
public interface PrimaryData_ResearchObjectLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link PrimaryData_ResearchObjectLocalServiceUtil} to access the primary data_ research object local service. Add custom service methods to {@link org.gfbio.service.impl.PrimaryData_ResearchObjectLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
