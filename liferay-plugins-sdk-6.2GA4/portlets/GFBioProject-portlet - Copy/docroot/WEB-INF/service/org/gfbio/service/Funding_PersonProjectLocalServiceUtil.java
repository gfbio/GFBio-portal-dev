...
public class Funding_PersonProjectLocalServiceUtil {
	...
	*/
	...
	public static org.json.simple.JSONObject createFundingPersonProject(
		org.json.simple.JSONObject requestJson) {
		return getService().createFundingPersonProject(requestJson);
	}

	public static java.lang.Boolean saveUpdateFundingPersonProject(
		long projectId, long fundingAgencyId, long fundingProgramId,
		long personId, java.lang.String personType) {
		return getService()
				   .saveUpdateFundingPersonProject(projectId, fundingAgencyId,
			fundingProgramId, personId, personType);
	}

	public static java.lang.Boolean updateFundingPersonProject(long projectId,
		long fundingAgencyId, long fundingProgramId, long personId,
		java.lang.String personType) {
		return getService()
				   .updateFundingPersonProject(projectId, fundingAgencyId,
			fundingProgramId, personId, personType);
	}
