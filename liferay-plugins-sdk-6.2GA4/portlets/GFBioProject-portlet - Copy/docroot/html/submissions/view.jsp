...
<%}}}%>
<%
ResearchObjectLocalServiceUtil.getResearchObjectInformationByUserId(userID);

JSONObject requestJson = new JSONObject();
requestJson.put("researchobjectid", userID);
...
JSONObject responseJson=ResearchObjectLocalServiceUtil.getResearchObjectAsJsonById(requestJson);
%>
