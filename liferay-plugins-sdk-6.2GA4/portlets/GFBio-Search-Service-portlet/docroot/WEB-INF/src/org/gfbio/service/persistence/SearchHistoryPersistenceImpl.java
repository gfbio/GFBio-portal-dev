...
public class SearchHistoryPersistenceImpl extends BasePersistenceImpl<SearchHistory>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_SINCE = new FinderPath(SearchHistoryModelImpl.ENTITY_CACHE_ENABLED,
			SearchHistoryModelImpl.FINDER_CACHE_ENABLED,
			SearchHistoryImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findBySince",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_COUNT_BY_SINCE = new FinderPath(SearchHistoryModelImpl.ENTITY_CACHE_ENABLED,
			SearchHistoryModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "countBySince",
			new String[] { Date.class.getName() });

	/**
	 * Returns all the search histories where lastModifiedDate &gt; &#63;.
	 *
	 * @param lastModifiedDate the last modified date
	 * @return the matching search histories
	 * @throws SystemException if a system exception occurred
	 */
	@Override
	public List<SearchHistory> findBySince(Date lastModifiedDate)
		throws SystemException {
	...
	/**
	 * Returns a range of all the search histories where lastModifiedDate &gt; &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link org.gfbio.model.impl.SearchHistoryModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	 ...
	 */
	@Override
	public List<SearchHistory> findBySince(Date lastModifiedDate, int start,
		int end) throws SystemException {
		return findBySince(lastModifiedDate, start, end, null);
	}

	/**
	 * Returns an ordered range of all the search histories where lastModifiedDate &gt; &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link org.gfbio.model.impl.SearchHistoryModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	public List<SearchHistory> findBySince(Date lastModifiedDate, int start,
		...
		if ((list != null) && !list.isEmpty()) {
			for (SearchHistory searchHistory : list) {
				if ((lastModifiedDate.getTime() >= searchHistory.getLastModifiedDate()
																	.getTime())) {
					list = null;
	...
	/**
	 * Returns the first search history in the ordered set where lastModifiedDate &gt; &#63;.
	 *
	 * @param lastModifiedDate the last modified date
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 * @return the first matching search history
	 ...
	 */
	@Override
	public SearchHistory findBySince_First(Date lastModifiedDate,
		OrderByComparator orderByComparator)
		throws NoSuchSearchHistoryException, SystemException {
		SearchHistory searchHistory = fetchBySince_First(lastModifiedDate,
				orderByComparator);
	 ...
	 */
	@Override
	public SearchHistory fetchBySince_First(Date lastModifiedDate,
		OrderByComparator orderByComparator) throws SystemException {
		List<SearchHistory> list = findBySince(lastModifiedDate, 0, 1,
				orderByComparator);
	...
	/**
	 * Returns the last search history in the ordered set where lastModifiedDate &gt; &#63;.
	 *
	 * @param lastModifiedDate the last modified date
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 * @return the last matching search history
	 ...
	 */
	@Override
	public SearchHistory findBySince_Last(Date lastModifiedDate,
		OrderByComparator orderByComparator)
		throws NoSuchSearchHistoryException, SystemException {
		SearchHistory searchHistory = fetchBySince_Last(lastModifiedDate,
				orderByComparator);
	 ...
	 */
	@Override
	public SearchHistory fetchBySince_Last(Date lastModifiedDate,
		OrderByComparator orderByComparator) throws SystemException {
		...
		List<SearchHistory> list = findBySince(lastModifiedDate, count - 1,
				count, orderByComparator);
	...
	/**
	 * Returns the search histories before and after the current search history in the ordered set where lastModifiedDate &gt; &#63;.
	 *
	 * @param searchHistoryID the primary key of the current search history
	 * @param lastModifiedDate the last modified date
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public SearchHistory[] findBySince_PrevAndNext(long searchHistoryID,
		Date lastModifiedDate, OrderByComparator orderByComparator)
		throws NoSuchSearchHistoryException, SystemException {
		SearchHistory searchHistory = findByPrimaryKey(searchHistoryID);
		...
		try {
			...
			array[0] = getBySince_PrevAndNext(session, searchHistory,
					lastModifiedDate, orderByComparator, true);

			array[1] = searchHistory;

			array[2] = getBySince_PrevAndNext(session, searchHistory,
	...
	protected SearchHistory getBySince_PrevAndNext(Session session,
		SearchHistory searchHistory, Date lastModifiedDate,
		OrderByComparator orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	/**
	 * Removes all the search histories where lastModifiedDate &gt; &#63; from the database.
	 *
	 * @param lastModifiedDate the last modified date
	 * @throws SystemException if a system exception occurred
	 */
	...
	public void removeBySince(Date lastModifiedDate) throws SystemException {
		for (SearchHistory searchHistory : findBySince(lastModifiedDate,
				QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
			remove(searchHistory);
		}
	}
	...
	/**
	 * Returns the number of search histories where lastModifiedDate &gt; &#63;.
	 *
	 * @param lastModifiedDate the last modified date
	 * @return the number of matching search histories
	 * @throws SystemException if a system exception occurred
	...
	private static final String _FINDER_COLUMN_SINCE_LASTMODIFIEDDATE_1 = "searchHistory.lastModifiedDate > NULL";
	private static final String _FINDER_COLUMN_SINCE_LASTMODIFIEDDATE_2 = "searchHistory.lastModifiedDate > ?";
	...
	protected SearchHistory toUnwrappedModel(SearchHistory searchHistory) {
		...
		searchHistoryImpl.setQueryFilter(searchHistory.getQueryFilter());
