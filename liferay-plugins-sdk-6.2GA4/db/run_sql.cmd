...
"%PSQL_HOME%\psql.exe" -h localhost -U postgres -d gfbio -f  insert_gfbio_category_researchobject.sql
...
REM "%PSQL_HOME%\psql.exe" -h localhost -U postgres -d gfbio -f  create_usersso.sql
REM "%PSQL_HOME%\psql.exe" -h localhost -U postgres -d gfbio -f  create_searchhistory.sql
