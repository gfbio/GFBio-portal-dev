...
public class Project_UserModelImpl extends BaseModelImpl<Project_User>
	...
	public static final String TABLE_SQL_CREATE = "create table gfbio_Project_User (projectID LONG not null,userID LONG not null,startDate DATE null,endDate DATE null,userType VARCHAR(75) null,lastmodifieddate DATE null,primary key (projectID, userID))";
	...
	public Object clone() {
		...
		project_UserImpl.setLastModifiedDate(getLastModifiedDate());
	...
	public CacheModel<Project_User> toCacheModel() {
		...
		if (lastModifiedDate != null) {
			project_UserCacheModel.lastModifiedDate = lastModifiedDate.getTime();
		}
		else {
			project_UserCacheModel.lastModifiedDate = Long.MIN_VALUE;
		}
