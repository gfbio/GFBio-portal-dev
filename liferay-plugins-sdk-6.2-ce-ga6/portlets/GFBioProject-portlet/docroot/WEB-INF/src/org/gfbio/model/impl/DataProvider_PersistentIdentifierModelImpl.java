...
public class DataProvider_PersistentIdentifierModelImpl extends BaseModelImpl<DataProvider_PersistentIdentifier>
	...
	public static final String TABLE_SQL_CREATE = "create table gfbio_DataProvider_PersistentIdentifier (gfbio_dataprovider LONG not null,gfbio_persistentidentifier LONG not null,lastmodifieddate DATE null,primary key (gfbio_dataprovider, gfbio_persistentidentifier))";
	...
	public Object clone() {
		...
		dataProvider_PersistentIdentifierImpl.setLastModifiedDate(getLastModifiedDate());
	...
	public CacheModel<DataProvider_PersistentIdentifier> toCacheModel() {
		...
		if (lastModifiedDate != null) {
			dataProvider_PersistentIdentifierCacheModel.lastModifiedDate = lastModifiedDate.getTime();
		}
		else {
			dataProvider_PersistentIdentifierCacheModel.lastModifiedDate = Long.MIN_VALUE;
		}
