...
public class ResearchObjectModelImpl extends BaseModelImpl<ResearchObject>
	...
	public static final Object[][] TABLE_COLUMNS = {
			...
			{ "publications", Types.VARCHAR },
			{ "datacollectiontime", Types.VARCHAR },
			{ "embargo", Types.TIMESTAMP },
			{ "lastmodifieddate", Types.TIMESTAMP }
		};
	public static final String TABLE_SQL_CREATE = "create table gfbio_ResearchObject (researchobjectid LONG not null,researchobjectversion INTEGER not null,parentresearchobjectid LONG,name VARCHAR(75) null,label VARCHAR(75) null,description VARCHAR(75) null,extendeddata VARCHAR(75) null,metadataid LONG,licenseid LONG,researchobjecttype VARCHAR(75) null,publications VARCHAR(75) null,datacollectiontime VARCHAR(75) null,embargo DATE null,lastmodifieddate DATE null,primary key (researchobjectid, researchobjectversion))";
	...
	public static ResearchObject toModel(ResearchObjectSoap soapModel) {
		...
		model.setDataCollectionTime(soapModel.getDataCollectionTime());
		model.setEmbargo(soapModel.getEmbargo());
	...
	public Map<String, Object> getModelAttributes() {
		...
		attributes.put("publications", getPublications());
		attributes.put("dataCollectionTime", getDataCollectionTime());
		attributes.put("embargo", getEmbargo());
	...
	public void setModelAttributes(Map<String, Object> attributes) {
		...
		String publications = (String)attributes.get("publications");

		if (publications != null) {
			setPublications(publications);
		}

		String dataCollectionTime = (String)attributes.get("dataCollectionTime");

		if (dataCollectionTime != null) {
			setDataCollectionTime(dataCollectionTime);
		}

		Date embargo = (Date)attributes.get("embargo");
	...
	public String getDataCollectionTime() {
		if (_dataCollectionTime == null) {
			return StringPool.BLANK;
		}
		else {
			return _dataCollectionTime;
		}
	}

	@Override
	public void setDataCollectionTime(String dataCollectionTime) {
		_dataCollectionTime = dataCollectionTime;
	}
	...
	public Object clone() {
		...
		researchObjectImpl.setPublications(getPublications());
		researchObjectImpl.setDataCollectionTime(getDataCollectionTime());
		researchObjectImpl.setEmbargo(getEmbargo());
		researchObjectImpl.setLastModifiedDate(getLastModifiedDate());
	...
	public CacheModel<ResearchObject> toCacheModel() {
		...
		researchObjectCacheModel.publications = getPublications();

		String publications = researchObjectCacheModel.publications;

		if ((publications != null) && (publications.length() == 0)) {
			researchObjectCacheModel.publications = null;
		}

		researchObjectCacheModel.dataCollectionTime = getDataCollectionTime();

		String dataCollectionTime = researchObjectCacheModel.dataCollectionTime;

		if ((dataCollectionTime != null) && (dataCollectionTime.length() == 0)) {
			researchObjectCacheModel.dataCollectionTime = null;
		}

		Date embargo = getEmbargo();

		if (embargo != null) {
			researchObjectCacheModel.embargo = embargo.getTime();
		}
		else {
			researchObjectCacheModel.embargo = Long.MIN_VALUE;
		}

		Date lastModifiedDate = getLastModifiedDate();

		if (lastModifiedDate != null) {
			researchObjectCacheModel.lastModifiedDate = lastModifiedDate.getTime();
		}
		else {
			researchObjectCacheModel.lastModifiedDate = Long.MIN_VALUE;
		}
	...
	public String toString() {
		...
		sb.append(getDataCollectionTime());
		sb.append(", embargo=");
		sb.append(getEmbargo());
	...
	public String toXmlString() {
		...
		sb.append("]]></column-value></column>");
		sb.append(
			"<column><column-name>dataCollectionTime</column-name><column-value><![CDATA[");
		sb.append(getDataCollectionTime());
		sb.append("]]></column-value></column>");
		sb.append(
			"<column><column-name>embargo</column-name><column-value><![CDATA[");
		sb.append(getEmbargo());
		sb.append("]]></column-value></column>");
		sb.append(
	...
	private String _dataCollectionTime;
	private Date _embargo;
