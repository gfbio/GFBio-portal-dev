...
import org.gfbio.service.DataManagementPlanLocalService;
...
import org.gfbio.service.persistence.DataManagementPlanFinder;
import org.gfbio.service.persistence.DataManagementPlanPersistence;
...
import org.gfbio.service.persistence.UserGoesternIDPersistence;
...
/**
 * Provides the base implementation for the data management plan local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.gfbio.service.impl.DataManagementPlanLocalServiceImpl}.
 * </p>
 *
 * @author Marcel Froemming
 * @see org.gfbio.service.impl.DataManagementPlanLocalServiceImpl
 * @see org.gfbio.service.DataManagementPlanLocalServiceUtil
 * @generated
 */
public abstract class DataManagementPlanLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements DataManagementPlanLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.gfbio.service.DataManagementPlanLocalServiceUtil} to access the data management plan local service.
	 */

	/**
	 * Adds the data management plan to the database. Also notifies the appropriate model listeners.
	 *
	 * @param dataManagementPlan the data management plan
	 * @return the data management plan that was added
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public DataManagementPlan addDataManagementPlan(
		DataManagementPlan dataManagementPlan) throws SystemException {
		dataManagementPlan.setNew(true);

		return dataManagementPlanPersistence.update(dataManagementPlan);
	}
	 ...
	 */
	@Override
	public DataManagementPlan createDataManagementPlan(long dmpID) {
		return dataManagementPlanPersistence.create(dmpID);
	}

	/**
	 * Deletes the data management plan with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 * @param dmpID the primary key of the data management plan
	 * @return the data management plan that was removed
	 * @throws PortalException if a data management plan with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.DELETE)
	@Override
	public DataManagementPlan deleteDataManagementPlan(long dmpID)
		throws PortalException, SystemException {
		return dataManagementPlanPersistence.remove(dmpID);
	}

	/**
	 * Deletes the data management plan from the database. Also notifies the appropriate model listeners.
	 *
	 * @param dataManagementPlan the data management plan
	 * @return the data management plan that was removed
	 * @throws SystemException if a system exception occurred
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public DataManagementPlan deleteDataManagementPlan(
		DataManagementPlan dataManagementPlan) throws SystemException {
		return dataManagementPlanPersistence.remove(dataManagementPlan);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(DataManagementPlan.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return dataManagementPlanPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return dataManagementPlanPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public DataManagementPlan fetchDataManagementPlan(long dmpID)
		throws SystemException {
		return dataManagementPlanPersistence.fetchByPrimaryKey(dmpID);
	}

	/**
	 * Returns the data management plan with the primary key.
	 *
	 * @param dmpID the primary key of the data management plan
	 ...
	 */
	@Override
	public DataManagementPlan getDataManagementPlan(long dmpID)
		throws PortalException, SystemException {
		return dataManagementPlanPersistence.findByPrimaryKey(dmpID);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return dataManagementPlanPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<DataManagementPlan> getDataManagementPlans(int start, int end)
		throws SystemException {
		return dataManagementPlanPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getDataManagementPlansCount() throws SystemException {
		return dataManagementPlanPersistence.countAll();
	}

	/**
	 * Updates the data management plan in the database or adds it if it does not yet exist. Also notifies the appropriate model listeners.
	 *
	 * @param dataManagementPlan the data management plan
	 * @return the data management plan that was updated
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public DataManagementPlan updateDataManagementPlan(
		DataManagementPlan dataManagementPlan) throws SystemException {
		return dataManagementPlanPersistence.update(dataManagementPlan);
	}
	...
	/**
	 * Returns the data management plan local service.
	 *
	 * @return the data management plan local service
	 */
	public org.gfbio.service.DataManagementPlanLocalService getDataManagementPlanLocalService() {
		return dataManagementPlanLocalService;
	}

	/**
	 * Sets the data management plan local service.
	 *
	 * @param dataManagementPlanLocalService the data management plan local service
	 */
	public void setDataManagementPlanLocalService(
		org.gfbio.service.DataManagementPlanLocalService dataManagementPlanLocalService) {
		this.dataManagementPlanLocalService = dataManagementPlanLocalService;
	}

	/**
	 * Returns the data management plan remote service.
	 *
	 * @return the data management plan remote service
	 */
	public org.gfbio.service.DataManagementPlanService getDataManagementPlanService() {
		return dataManagementPlanService;
	}

	/**
	 * Sets the data management plan remote service.
	 *
	 * @param dataManagementPlanService the data management plan remote service
	 */
	public void setDataManagementPlanService(
		org.gfbio.service.DataManagementPlanService dataManagementPlanService) {
		this.dataManagementPlanService = dataManagementPlanService;
	}

	/**
	 * Returns the data management plan persistence.
	 *
	 * @return the data management plan persistence
	 */
	public DataManagementPlanPersistence getDataManagementPlanPersistence() {
		return dataManagementPlanPersistence;
	}

	/**
	 * Sets the data management plan persistence.
	 *
	 * @param dataManagementPlanPersistence the data management plan persistence
	 */
	public void setDataManagementPlanPersistence(
		DataManagementPlanPersistence dataManagementPlanPersistence) {
		this.dataManagementPlanPersistence = dataManagementPlanPersistence;
	}

	/**
	 * Returns the data management plan finder.
	 *
	 * @return the data management plan finder
	 */
	public DataManagementPlanFinder getDataManagementPlanFinder() {
		return dataManagementPlanFinder;
	}

	/**
	 * Sets the data management plan finder.
	 *
	 * @param dataManagementPlanFinder the data management plan finder
	 */
	public void setDataManagementPlanFinder(
		DataManagementPlanFinder dataManagementPlanFinder) {
		this.dataManagementPlanFinder = dataManagementPlanFinder;
	}
	...
	/**
	 * Returns the user goestern i d local service.
	 *
	 * @return the user goestern i d local service
	 */
	public org.gfbio.service.UserGoesternIDLocalService getUserGoesternIDLocalService() {
		return userGoesternIDLocalService;
	}

	/**
	 * Sets the user goestern i d local service.
	 *
	 * @param userGoesternIDLocalService the user goestern i d local service
	 */
	public void setUserGoesternIDLocalService(
		org.gfbio.service.UserGoesternIDLocalService userGoesternIDLocalService) {
		this.userGoesternIDLocalService = userGoesternIDLocalService;
	}

	/**
	 * Returns the user goestern i d remote service.
	 *
	 * @return the user goestern i d remote service
	 */
	public org.gfbio.service.UserGoesternIDService getUserGoesternIDService() {
		return userGoesternIDService;
	}

	/**
	 * Sets the user goestern i d remote service.
	 *
	 * @param userGoesternIDService the user goestern i d remote service
	 */
	public void setUserGoesternIDService(
		org.gfbio.service.UserGoesternIDService userGoesternIDService) {
		this.userGoesternIDService = userGoesternIDService;
	}

	/**
	 * Returns the user goestern i d persistence.
	 *
	 * @return the user goestern i d persistence
	 */
	public UserGoesternIDPersistence getUserGoesternIDPersistence() {
		return userGoesternIDPersistence;
	}

	/**
	 * Sets the user goestern i d persistence.
	 *
	 * @param userGoesternIDPersistence the user goestern i d persistence
	 */
	public void setUserGoesternIDPersistence(
		UserGoesternIDPersistence userGoesternIDPersistence) {
		this.userGoesternIDPersistence = userGoesternIDPersistence;
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("org.gfbio.model.DataManagementPlan",
			dataManagementPlanLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = dataManagementPlanPersistence.getDataSource();
	...
	@BeanReference(type = org.gfbio.service.DataManagementPlanLocalService.class)
	protected org.gfbio.service.DataManagementPlanLocalService dataManagementPlanLocalService;
	@BeanReference(type = org.gfbio.service.DataManagementPlanService.class)
	protected org.gfbio.service.DataManagementPlanService dataManagementPlanService;
	@BeanReference(type = DataManagementPlanPersistence.class)
	protected DataManagementPlanPersistence dataManagementPlanPersistence;
	@BeanReference(type = DataManagementPlanFinder.class)
	protected DataManagementPlanFinder dataManagementPlanFinder;
	...
	@BeanReference(type = org.gfbio.service.UserGoesternIDLocalService.class)
	protected org.gfbio.service.UserGoesternIDLocalService userGoesternIDLocalService;
	@BeanReference(type = org.gfbio.service.UserGoesternIDService.class)
	protected org.gfbio.service.UserGoesternIDService userGoesternIDService;
	@BeanReference(type = UserGoesternIDPersistence.class)
	protected UserGoesternIDPersistence userGoesternIDPersistence;
	...
	private DataManagementPlanLocalServiceClpInvoker _clpInvoker = new DataManagementPlanLocalServiceClpInvoker();
}