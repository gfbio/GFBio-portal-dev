...
public class SubmissionPersistenceImpl extends BasePersistenceImpl<Submission>
	 ...
	 */
	@Override
	public List<Submission> findByResearchObjectIDAndVersion(
	 ...
	 */
	@Override
	public Submission findByResearchObjectIDAndVersion_First(
		long researchObjectID, int researchObjectVersion,
		OrderByComparator orderByComparator)
		throws NoSuchSubmissionException, SystemException {
		Submission submission = fetchByResearchObjectIDAndVersion_First(researchObjectID,
	 ...
	 */
	@Override
	public Submission fetchByResearchObjectIDAndVersion_First(
		long researchObjectID, int researchObjectVersion,
		OrderByComparator orderByComparator) throws SystemException {
		List<Submission> list = findByResearchObjectIDAndVersion(researchObjectID,
	 ...
	 */
	@Override
	public Submission findByResearchObjectIDAndVersion_Last(
		long researchObjectID, int researchObjectVersion,
		OrderByComparator orderByComparator)
		throws NoSuchSubmissionException, SystemException {
		Submission submission = fetchByResearchObjectIDAndVersion_Last(researchObjectID,
				researchObjectVersion, orderByComparator);
	 ...
	 */
	@Override
	public Submission fetchByResearchObjectIDAndVersion_Last(
		long researchObjectID, int researchObjectVersion,
		OrderByComparator orderByComparator) throws SystemException {
	 ...
	 */
	@Override
	public Submission[] findByResearchObjectIDAndVersion_PrevAndNext(
	...
	protected Submission getByResearchObjectIDAndVersion_PrevAndNext(
	...
	public void removeByResearchObjectIDAndVersion(long researchObjectID,
		...
		for (Submission submission : findByResearchObjectIDAndVersion(
	...
	protected Submission toUnwrappedModel(Submission submission) {
		...
		submissionImpl.setJiraID(submission.getJiraID());
		submissionImpl.setJiraKey(submission.getJiraKey());
	...
	private static Set<String> _badColumnNames = SetUtil.fromArray(new String[] {
				"submissionID", "isPublic", "lastChanged", "publicAfter",
				"researchObjectVersion", "archivePIDType", "researchObjectID",
				"userID", "archivePID", "brokerSubmissionID", "jiraID",
				"jiraKey"
			});
