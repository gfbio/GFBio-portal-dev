...
public class ContentModelImpl extends BaseModelImpl<Content>
	...
	public static final String TABLE_SQL_CREATE = "create table gfbio_Content (contentID LONG not null primary key,headID LONG,columnID LONG,rowID LONG,cellContent VARCHAR(75) null,lastmodifieddate DATE null)";
	...
	public Object clone() {
		...
		contentImpl.setLastModifiedDate(getLastModifiedDate());
	...
	public CacheModel<Content> toCacheModel() {
		...
		if (lastModifiedDate != null) {
			contentCacheModel.lastModifiedDate = lastModifiedDate.getTime();
		}
		else {
			contentCacheModel.lastModifiedDate = Long.MIN_VALUE;
		}
