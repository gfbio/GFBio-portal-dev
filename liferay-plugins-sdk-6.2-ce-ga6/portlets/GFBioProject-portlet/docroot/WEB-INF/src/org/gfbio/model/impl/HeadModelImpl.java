...
public class HeadModelImpl extends BaseModelImpl<Head> implements HeadModel {
	...
	public static final String TABLE_SQL_CREATE = "create table gfbio_Head (headID LONG not null primary key,table_name VARCHAR(75) null,table_type VARCHAR(75) null,lastmodifieddate DATE null)";
	...
	public Object clone() {
		...
		headImpl.setLastModifiedDate(getLastModifiedDate());
	...
	public CacheModel<Head> toCacheModel() {
		...
		if (lastModifiedDate != null) {
			headCacheModel.lastModifiedDate = lastModifiedDate.getTime();
		}
		else {
			headCacheModel.lastModifiedDate = Long.MIN_VALUE;
		}
