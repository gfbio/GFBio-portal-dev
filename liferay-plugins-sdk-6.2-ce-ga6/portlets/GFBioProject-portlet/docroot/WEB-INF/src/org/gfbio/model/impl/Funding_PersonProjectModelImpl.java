...
public class Funding_PersonProjectModelImpl extends BaseModelImpl<Funding_PersonProject>
	...
	public static final String TABLE_SQL_CREATE = "create table gfbio_Funding_PersonProject (projectID LONG not null,fundingAgencyID LONG not null,fundingProgramID LONG not null,personID LONG not null,personType VARCHAR(75) not null,lastmodifieddate DATE null,primary key (projectID, fundingAgencyID, fundingProgramID, personID, personType))";
	...
	public Object clone() {
		...
		funding_PersonProjectImpl.setLastModifiedDate(getLastModifiedDate());
	...
	public CacheModel<Funding_PersonProject> toCacheModel() {
		...
		if (lastModifiedDate != null) {
			funding_PersonProjectCacheModel.lastModifiedDate = lastModifiedDate.getTime();
		}
		else {
			funding_PersonProjectCacheModel.lastModifiedDate = Long.MIN_VALUE;
		}
